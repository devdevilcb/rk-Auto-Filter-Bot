...
# Bot information
API_ID = environ.get('API_ID', '20650942')  #api id of your telegram id
if len(API_ID) == 0:
    print('Error - API_ID is missing, exiting now')
    exit()
else:
    API_ID = int(API_ID)
API_HASH = environ.get('API_HASH', '9744c99858433c55c279cce6827d36a4') #api hash of your telegram id
if len(API_HASH) == 0:
...
# Bot Admins
ADMINS = environ.get('ADMINS', '5007198306 1947565279') #apni tg id daalo
if len(ADMINS) == 0:
...
AUTH_CHANNEL = [int(auth_channels) for auth_channels in environ.get('AUTH_CHANNEL', '-1001694264592').split()]
...
PAYMENT_QR = environ.get('PAYMENT_QR', 'https://telegra.ph/file/58fef5cb458d5b29b0186.jpg') #telegraph link of your QR code 
UPI_ID = environ.get('UPI_ID', 'skumar2907@barodampay') # Add your upi id here
# for stream
...
URL = environ.get("URL", "https://curved-corabel-devdoc-61e11e30.koyeb.app/") #if heroku then paste the app link here ex: https://heroku......./
if len(URL) == 0:
